...
local cyclone_menu_elements =
{
    ...
    main_boolean       = checkbox:new(true, get_hash(my_utility.plugin_label .. "disable_enable_cyclone")),
    min_max_targets    = slider_int:new(0, 30, 0, get_hash(my_utility.plugin_label .. "min_max_number_of_targets_for_cast_cyclone"))
}
...
local function logics()
    ...
    if cast_spell.self(spell_data.cyclone_armor.spell_id, 0.0) then
